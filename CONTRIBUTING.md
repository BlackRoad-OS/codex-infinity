# Contributing to codex-infinity
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/codex-infinity.git
cd codex-infinity

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/codex-infinity.git
